#ifndef POST_DECONTAMINATION_H
#define POST_DECONTAMINATION_H
...
class post_decontamination : public QObject {
    Q_OBJECT
    ...
    public:
        explicit post_decontamination(QSqlDatabase database, QObject *parent = nullptr);
