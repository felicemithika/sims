#ifndef END_AUTOCLAVING_H
#define END_AUTOCLAVING_H
...
class end_autoclaving : public QObject {
    Q_OBJECT
    ...
    public:
        explicit end_autoclaving(QSqlDatabase database, QObject *parent = nullptr);
