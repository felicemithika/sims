#ifndef PRE_DECONTAMINATION_H
#define PRE_DECONTAMINATION_H
...
class pre_decontamination : public QObject {
    Q_OBJECT
    ...
    public:
        explicit pre_decontamination(QSqlDatabase database, QObject *parent = nullptr);
